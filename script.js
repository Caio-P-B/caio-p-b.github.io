...
const projectDetails = [
  {
    title: "TabNews Clone",
    image:
      "https://images.unsplash.com/photo-1584438784894-089d6a62b8fa?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    features: [
      ...
      'Sistema "Financeiro" (Tab Coins)',
      "Otimização SEO e performance",
    ],
    challenges:
      "Implementar um sistema completo capaz de suportar um alto número de acessos Simultâneos de forma segura",
    results:
      "Sistema seguro que encosta na realidade e em maior nível de segurança",
  },
  {
    title: "App de Anotações com Sincronização Offline",
    image:
      "https://images.unsplash.com/photo-1608222351212-18fe0ec7b13b?w=1200&q=80",
    ...
    challenges:
      "Implementar PWA, Implementar PWA, Banco de dados local IndexedDB",
    results: "Prova de nível avançado em web moderna.",
  },
  {
    title: "App Meteorológico Avançado com Animações",
    image:
      "https://images.unsplash.com/photo-1710870509663-16f20f75d758?w=1200&q=80",
    tags: ["React", "Framer Motion", "Weather API"],
    description:
      "Aplicativo com previsões e animações de clima super detalhadas.",
    features: [
  ...
  button.addEventListener("click", (e) => {
    ...
    modalBody.innerHTML = `
      ...
      project.title
            ...
            <h2 style="font-size: 2rem; color: var(--dark-color); margin-bottom: 20px;">${
              project.title
            }</h2>
            ...
            <p style="color: var(--medium-color); font-size: 1.1rem; line-height: 1.8; margin-bottom: 30px;">${
              project.description
            }</p>
            ...
            <p style="color: var(--medium-color); line-height: 1.8; margin-bottom: 30px;">${
              project.challenges
            }</p>
            
            <h3 style="font-size: 1.3rem; color: var(--dark-color); margin-bottom: 15px;">📊 Resultados</h3>
            <p style="color: var(--medium-color); line-height: 1.8;">${
              project.results
            }</p>
        `;
